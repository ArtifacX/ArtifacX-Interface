...
const Divider = (props) => {
  return (
    <div className={styles.cautionTape} style={{margin: `${props.margin}`, height: '45px', width: '100%', backgroundColor: '#EAD83A', transform: `rotate(${props.angle}deg)`, verticalAlign: 'center'}}>
